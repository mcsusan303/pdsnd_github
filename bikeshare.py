...
def get_filters():
    ...
    while True:
        city = input("Enter name of city to use (Chicago, New York City, or Washington):").lower()
    ...
    while True:
        day = input("Enter day of week to use.  If you would like all days, enter keyword all:  ").lower()
